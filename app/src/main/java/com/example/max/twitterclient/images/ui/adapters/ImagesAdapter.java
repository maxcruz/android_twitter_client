package com.example.max.twitterclient.images.ui.adapters;
...
public class ImagesAdapter extends RecyclerView.Adapter<ImagesAdapter.ViewHolder> {
    ...
    public ImagesAdapter(List<Image> dataset, ImageLoader imageLoader, OnImageClickListener clickListener) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtLikeCount.setText(String.valueOf(imageTweet.getFavoriteCount()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setOnClickListener(final Image image, final OnImageClickListener listener) {
